...
from flaskblog.users.forms import RegistrationForm, LoginForm, UpdateProfileForm, AddSport, ResetPasswordForm, RequestResetForm
from flaskblog.models import User, Sport, SportPlayed
from flask_login import login_user, current_user, logout_user, login_required
from flaskblog.users.utils import save_picture, send_reset_email, send_mail, mailobject
...
def register():
    ...
    if form.validate_on_submit():
        ...
        #send_mail(form.email.data, 'You have registered succesfully, check your email',
         #         'mail',
          #        name=form.name.data,
...
def send_reset_email(user):
    ...
    msg.html = render_template('reset_mail.html', user=user, token=token, _external=True)
    mailobject.send(msg)